...
// Custom metrics
const httpRequestDuration = register.getSingleMetric('http_request_duration_seconds') || new client.Histogram({
...
const httpRequestTotal = register.getSingleMetric('http_requests_total') || new client.Counter({
...
const activeUsers = register.getSingleMetric('active_users') || new client.Gauge({
    name: 'active_users',
    help: 'Number of currently active users',
    registers: [register]
});

const errorTotal = register.getSingleMetric('errors_total') || new client.Counter({
    name: 'errors_total',
...
const dbQueryDuration = register.getSingleMetric('db_query_duration_seconds') || new client.Histogram({
