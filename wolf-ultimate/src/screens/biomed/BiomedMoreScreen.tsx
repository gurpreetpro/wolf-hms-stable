...
import { Wrench, AlertTriangle, Calendar, Shield, Settings, MessageSquare, HelpCircle } from 'lucide-react-native';
...
const SECTIONS = [
  { title: 'Equipment', items: [
    { icon: Wrench, label: 'Breakdown Tickets', screen: 'BreakdownTickets', color: '#ef4444' },
    { icon: Calendar, label: 'PM Schedule', screen: 'MaintenanceSchedule', color: '#3b82f6' },
    { icon: AlertTriangle, label: 'Calibration Logs', screen: 'CalibrationLogs', color: '#8b5cf6' },
    { icon: Shield, label: 'AMC Dashboard', screen: 'AMCDashboard', color: '#10b981' },
  ]},
  { title: 'General', items: [
...
export const BiomedMoreScreen = ({ navigation }: any) => {
