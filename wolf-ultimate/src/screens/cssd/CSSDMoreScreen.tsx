...
import { Activity, Package, ClipboardList, AlertTriangle, Settings, MessageSquare, HelpCircle } from 'lucide-react-native';
import { FONTS, SPACING } from '../../theme/theme';
import { GlassCard } from '../../components/common/GlassCard';
import { useTheme } from '../../theme/ThemeContext';

const SECTIONS = [
  { title: 'Sterilization', items: [
    { icon: Activity, label: 'Sterilization Cycles', screen: 'SterilizationCycles', color: '#3b82f6' },
    { icon: Package, label: 'Instrument Tracking', screen: 'InstrumentTracking', color: '#10b981' },
    { icon: ClipboardList, label: 'Load Logs', screen: 'LoadLogs', color: '#8b5cf6' },
    { icon: AlertTriangle, label: 'Bio Indicators', screen: 'BioIndicator', color: '#ef4444' },
  ]},
  { title: 'General', items: [
...
export const CSSDMoreScreen = ({ navigation }: any) => {
