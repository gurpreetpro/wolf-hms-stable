...
import { FileText, ClipboardList, Shield, BarChart3, Settings, MessageSquare, HelpCircle } from 'lucide-react-native';
...
const SECTIONS = [
  { title: 'Records', items: [
    { icon: FileText, label: 'Record Requests', screen: 'RecordRequests', color: '#3b82f6' },
    { icon: ClipboardList, label: 'ICD Coding', screen: 'ICDCoding', color: '#8b5cf6' },
    { icon: Shield, label: 'MLC Cases', screen: 'MLCCases', color: '#ef4444' },
    { icon: BarChart3, label: 'Audit Trail', screen: 'AuditTrail', color: '#10b981' },
  ]},
  { title: 'General', items: [
...
export const HIMMoreScreen = ({ navigation }: any) => {
