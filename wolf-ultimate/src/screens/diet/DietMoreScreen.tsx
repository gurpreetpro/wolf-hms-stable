...
import { UtensilsCrossed, ClipboardList, AlertTriangle, BarChart3, Settings, MessageSquare, HelpCircle } from 'lucide-react-native';
...
const SECTIONS = [
  {
    ...
    items: [
      { icon: UtensilsCrossed, label: 'Meal Planning', screen: 'MealPlanning', color: '#3b82f6' },
      { icon: ClipboardList, label: 'Kitchen Orders', screen: 'KitchenOrders', color: '#10b981' },
      { icon: AlertTriangle, label: 'Allergy Management', screen: 'AllergyManagement', color: '#ef4444' },
      { icon: BarChart3, label: 'Nutrition Analytics', screen: 'NutritionAnalytics', color: '#8b5cf6' },
    ],
  },
  {
    title: 'General',
...
export const DietMoreScreen = ({ navigation }: any) => {
