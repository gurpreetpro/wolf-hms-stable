...
import {
  Scan, FileText, AlertTriangle, Radio,
  Settings, MessageSquare, HelpCircle, BarChart3,
  ClipboardList, Zap,
...
const SECTIONS = [
  {
    title: 'Imaging',
    items: [
      { icon: Scan, label: 'Imaging Worklist', screen: 'ImagingWorklist', color: '#3b82f6' },
      { icon: FileText, label: 'Radiology Reports', screen: 'RadiologyReport', color: '#10b981' },
      { icon: ClipboardList, label: 'Report Authorization', screen: 'ReportAuthorization', color: '#8b5cf6' },
      { icon: AlertTriangle, label: 'Critical Findings', screen: 'CriticalFinding', color: '#ef4444' },
    ],
  },
  {
    title: 'Safety & Analytics',
    items: [
      { icon: Radio, label: 'Radiation Dose Log', screen: 'RadiationDose', color: '#f59e0b' },
      { icon: Zap, label: 'Radiology AI', screen: 'RadiologyAI', color: '#06b6d4' },
      { icon: BarChart3, label: 'TAT Analytics', screen: 'Settings', color: '#14b8a6' },
    ],
  },
  {
    title: 'General',
...
export const RadiologyMoreScreen = ({ navigation }: any) => {
