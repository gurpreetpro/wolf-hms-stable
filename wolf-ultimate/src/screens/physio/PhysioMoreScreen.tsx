...
import {
  ClipboardList, Calendar, Activity, TrendingDown,
  Settings, MessageSquare, HelpCircle, Home,
...
const SECTIONS = [
  {
    title: 'Clinical',
    items: [
      { icon: ClipboardList, label: 'Exercise Prescriptions', screen: 'ExercisePrescription', color: '#3b82f6' },
      { icon: Calendar, label: 'Session Log', screen: 'SessionLog', color: '#10b981' },
      { icon: Activity, label: 'ADL Assessment', screen: 'ADLAssessment', color: '#f59e0b' },
      { icon: TrendingDown, label: 'Outcome Scoring (FIM)', screen: 'OutcomeScoring', color: '#8b5cf6' },
    ],
  },
  {
    title: 'Patient Tools',
    items: [
      { icon: Home, label: 'Home Exercise Plans', screen: 'HomeExercise', color: '#06b6d4' },
      { icon: TrendingDown, label: 'Rehab Progress', screen: 'RehabProgress', color: '#14b8a6' },
    ],
  },
  {
    title: 'General',
...
export const PhysioMoreScreen = ({ navigation }: any) => {
